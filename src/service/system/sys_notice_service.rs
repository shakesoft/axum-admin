...
use crate::common::result::{ok, ok_result_empty, ok_result_data, Page};
...
impl SysNoticeService {
    ...
    pub async fn query_sys_notice_list(rb: &RBatis, item: QueryNoticeListReq) -> ServiceResult<Page<NoticeResp>> {
