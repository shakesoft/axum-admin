...
#[utoipa::path(
    ...
    responses((status = 200, description = "successfully", body = BaseResponse<DictDataResp>))
)]
#[function_name::named]
...
#[utoipa::path(
    ...
    responses((status = 200, description = "successfully", body = BaseResponse<Paged<DictDataResp>>))
)]
#[function_name::named]
